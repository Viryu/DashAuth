...
$(function() {
    ...
    $("#flot-pie-chart").bind("plotclick",function(event,pos,item){
        if(item){
            if(item.series.label == "Succesful Sales"){
                window.location.href = "/salesonly";
            }
            else{
                window.location.href = "/failtransaction";
            }
        }
    });
    $(document).ready(function(){
        chart = $.plot($("#flot-pie-chart"),data,options);
    });
...
$(function() {
    if(settarget == 0){
        ...
        var angka = settarget - totalmoney;
    }
    var data = [{
        label: "income from target",
        data: totalmoney
    }, {
    ...
    // $("#flot-pie-chart1").bind("plotclick",function(event,pos,item){
    //     if(item){
    //         if(item.series.label == "Succesful Sales"){
    //             window.location.href = "/salesonly";
    //         }
    ...
    // });
    $(document).ready(function(){
        chart = $.plot($("#flot-pie-chart1"),data,options);
    });
